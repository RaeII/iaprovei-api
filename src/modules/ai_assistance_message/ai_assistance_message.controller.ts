...
import {
  AiAssistanceMessageQuerySchema,
  ...
  AiAssistanceMessageCreateSchema,
  aiAssistanceMessageListResponseOpenapi,
  aiAssistanceMessageDetailedListResponseOpenapi,
  aiAssistanceMessageDetailResponseOpenapi,
  aiAssistanceMessageCountResponseOpenapi,
  aiAssistanceMessageExistsResponseOpenapi,
  aiAssistanceMessageCreateOpenapi,
...
export class AiAssistanceMessageController {
  ...
  async create(
    @Body(new ZodValidationPipe(AiAssistanceMessageCreateSchema))
  ...
  async findAll(
    @Query(new ZodValidationPipe(AiAssistanceMessageQuerySchema)) query: AiAssistanceMessageQuery,
    @Req() req: Request
  ...
  async count(
    @Query(
      new ZodValidationPipe(
        AiAssistanceMessageQuerySchema.pick({ assistence_sessions_id: true, sender: true, message_type: true })
      )
    )
    query: Partial<AiAssistanceMessageQuery>,
    @Req() req: Request
  ...
  async findBySessionId(
    ...
    @Query(new ZodValidationPipe(AiAssistanceMessageQuerySchema.omit({ assistence_sessions_id: true })))
